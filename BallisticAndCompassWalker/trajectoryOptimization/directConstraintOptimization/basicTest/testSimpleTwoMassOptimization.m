function [] = testSimpleTwoMassOptimization()
%%
numStates = 25;
dt = 0.1;
...
ce = [ce state.states(:, 1)' - [0 1 0 0]; % initial position and velocity
% ce = [ce state.states(:, end)' - [1 0]]; % final position and velocity
ce = [ce state.states(2, end)' - 2]; % final position and velocity
